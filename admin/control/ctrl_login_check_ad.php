<?php
	...
	if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
		if(!tv_login_ad($_SESSION['username'],$_SESSION['password'])){
	...
	$hoi_user = "SELECT * FROM `nhanvien` WHERE BINARY `TenDangNhap` = '".$_SESSION['username']."' and `MatKhau` = '".md5($_SESSION['password'])."' and trangthainv='0' and DaXoa = '0' and LoaiNV = '0'";
