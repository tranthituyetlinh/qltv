              ...
              while ($row = mysqli_fetch_assoc($dulieu)) {
                ?>
                  <tr>
                    ...
                    <td class="giua"><div class="nut nam-giua"><a class="btn btn-danger btn-xuat-sach" data-qltv="<?php echo $row['MaS']; ?>" title="Sửa"><i class="fa fa-minus" aria-hidden="true"></i></a></div>
                    </td>
